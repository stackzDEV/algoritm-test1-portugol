...
operators = input('escolha o operador desejado \nADIÇÃO = [+]  \nSUBTRAÇÃO = [-]   \nMULTIPLICAÇÃO = [x] \nDIVISÃO = [/] \nRAIZ QUADRADA = [v] \nPORCENTAGEM = [%] \nADIÇÃO DE PORCENTAGEM = [%+] \nSUBTRAÇÃO DE PORCENTAGEM = [%-] \nCONVERSOR DE DÓLAR = [$] \nCONVERSOR DE EURO = [£] \nCONVERSOR DE BITICOIN = [B] : ')

# operadores validos atualmente
while (operators != "+" and operators != "-" and operators != "x" and operators != "/" and operators != "v" and operators != "%" and operators != "%+" and operators != "%-" and operators != "$" and operators != "£" and operators != "B" ):
